...
public class RatingAMQPConfig {
    ...
    @Bean
    public Queue RatingDetailsQueue() {
        return QueueBuilder
    ...
    @Bean
    public Queue RatingDetailsQueueDlq() {
        return QueueBuilder
    ...
    @Bean
    public Binding orderPayment() {
        return BindingBuilder
                .bind(RatingDetailsQueue())
                .to(fanoutExchange());
    }

    @Bean
    public Binding OrderPaymentDlx() {
        return BindingBuilder
                .bind(RatingDetailsQueueDlq())
